...
extern "C" void ui_kartlog_create(lv_obj_t *parent)
{
    ...
    lv_obj_align(s_ui.status, LV_ALIGN_CENTER, 0, -70);
    ...
    lv_obj_align(s_ui.elapsed, LV_ALIGN_CENTER, 0, -10);
    ...
    lv_obj_align(s_ui.samples, LV_ALIGN_CENTER, 0, 36);
    ...
    lv_obj_align(s_ui.fname, LV_ALIGN_CENTER, 0, 78);
    ...
    lv_label_set_text(hint, "press PWR to start / stop");
